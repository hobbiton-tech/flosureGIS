...
import { PolicyPaymentPlan, IPaymentModel } from '../../../models/payment-plans.model';
...
export class PaymentPlanPoliciesComponent implements OnInit {
  ...
  viewPaymentPlanPolicyInstallments(paymentPlanPolicy: PolicyPaymentPlan) {
        this.router.navigateByUrl('/flosure/accounts/payment-plan/' + this.paymentPlanId + '/' + paymentPlanPolicy.policyNumber)
  }
}
