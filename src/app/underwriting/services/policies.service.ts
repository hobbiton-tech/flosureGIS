...
export class PoliciesService implements OnDestroy {
    ...
    //     return this.http.get<Policy[]>('http://test-main.flosure-api.com/policy');
    ...
    //         `http://test-main.flosure-api.com/policy/${policyId}`
    ...
    updatePolicy(policy: Policy): Observable<Policy> {
        return this.http.put<Policy>(
            `http://test-main.flosure-api.com/policy/${policy.id}`,
            policy
        );
    }
    ...
    createBackupPolicy(policy: Policy): Observable<Policy> {
        return this.http.post<Policy>(
            'http://test-main.flosure-api.com/policy',
            policy
        );
    }
