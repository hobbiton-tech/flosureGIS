...
export class PoliciesService implements OnDestroy {
    ...
    //     return this.http.get<Policy[]>('https://api.goldenlotusinsurance.com/policy');
    ...
    //         `https://api.goldenlotusinsurance.com/policy/${policyId}`
    ...
    updatePolicy(policy: Policy): Observable<Policy> {
        return this.http.put<Policy>(
            `https://api.goldenlotusinsurance.com/policy/${policy.id}`,
            policy
        );
    }
    ...
    createBackupPolicy(policy: Policy): Observable<Policy> {
        return this.http.post<Policy>(
            'https://api.goldenlotusinsurance.com/policy',
            policy
        );
    }
