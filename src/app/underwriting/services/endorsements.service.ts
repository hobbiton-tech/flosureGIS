...
export class EndorsementService {
    ...
    createEndorsement(
        ...
        console.log(endorsement);
        return this.http.post<Endorsement>(
            `http://api.goldenlotusinsurance.com/endorsement/${policyId}`,
    ...
    getEndorsements(): Observable<Endorsement[]> {
        return this.http.get<Endorsement[]>(
            'http://api.goldenlotusinsurance.com/endorsement'
        );
    }

    getEndorsementById(endorsementId: string): Observable<Endorsement> {
        return this.http.get<Endorsement>(
            `http://api.goldenlotusinsurance.com/endorsement/${endorsementId}`
        );
    }
