...
@Component({
    selector: 'app-marine-premium-computation-details',
    templateUrl: './marine-premium-computation-details.component.html',
    styleUrls: ['./marine-premium-computation-details.component.scss']
})
export class MarinePremiumComputationDetailsComponent
