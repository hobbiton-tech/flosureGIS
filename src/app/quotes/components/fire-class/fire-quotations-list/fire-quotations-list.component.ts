...
@Component({
    selector: 'app-fire-quotations-list',
    templateUrl: './fire-quotations-list.component.html',
    styleUrls: ['./fire-quotations-list.component.scss']
})
export class FireQuotationsListComponent implements OnInit, OnDestroy {
