...
@Component({
    selector: 'app-accident-quotations-list',
    templateUrl: './accident-quotations-list.component.html',
    styleUrls: ['./accident-quotations-list.component.scss']
})
export class AccidentQuotationsListComponent implements OnInit, OnDestroy {
