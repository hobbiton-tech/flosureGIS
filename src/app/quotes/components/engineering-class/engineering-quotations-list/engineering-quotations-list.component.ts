...
@Component({
    selector: 'app-engineering-quotations-list',
    templateUrl: './engineering-quotations-list.component.html',
    styleUrls: ['./engineering-quotations-list.component.scss']
})
export class EngineeringQuotationsListComponent implements OnInit {
