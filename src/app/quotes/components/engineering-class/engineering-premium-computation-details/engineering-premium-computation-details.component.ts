...
import { AccidentProductTypeOptions } from 'src/app/quotes/selection-options';
import moment from 'moment';

@Component({
    selector: 'app-engineering-premium-computation-details',
    templateUrl: './engineering-premium-computation-details.component.html',
    styleUrls: ['./engineering-premium-computation-details.component.scss']
})
export class EngineeringPremiumComputationDetailsComponent
