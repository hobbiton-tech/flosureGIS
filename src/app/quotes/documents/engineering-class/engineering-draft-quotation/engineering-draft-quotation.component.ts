...
@Component({
    selector: 'app-engineering-draft-quotation',
    templateUrl: './engineering-draft-quotation.component.html',
    styleUrls: ['./engineering-draft-quotation.component.scss']
})
export class EngineeringDraftQuotationComponent implements OnInit {
    @Input()
    quoteNumber: string;
