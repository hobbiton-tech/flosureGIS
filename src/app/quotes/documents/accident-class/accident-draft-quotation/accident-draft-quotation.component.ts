...
@Component({
    selector: 'app-accident-draft-quotation',
    templateUrl: './accident-draft-quotation.component.html',
    styleUrls: ['./accident-draft-quotation.component.scss']
})
export class AccidentDraftQuotationComponent implements OnInit {
    @Input()
    quoteNumber: string;
